...
abstract class Image_Driver {
	 ...
	 * @return  boolean
	 */
	abstract public function process($image, $actions, $dir, $file, $format = null);
	...
	/**
	 * Crops proportional piece of image
	 * @abstract
	 * @param array $properties
	 */
	abstract public function frame($properties);
	abstract public function canvas($properties);
	 ...
	 * @abstract
	 * @param int $amount. Valid amount are 1 to 100.
	 * @return bool
	 */
	abstract public function brightness($amount);
	abstract public function blur();
